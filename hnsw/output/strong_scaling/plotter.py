...
def plot_model_metrics(csv_path: str, save_path: str):
    ...
    for i, metric in enumerate(metrics):
        ...
        for model in df["model"].unique():
            ...
            ax.plot(grouped["num_procs"], grouped[metric], marker='o', label=model)
...
def combine_csv_files(prefix: str, output_file: str = "strong_scaling.csv"):
...
combine_csv_files("./raw/strong_scaling", "strong_scaling.csv")
plot_model_metrics("strong_scaling.csv", "strong_scaling_plot.png")
