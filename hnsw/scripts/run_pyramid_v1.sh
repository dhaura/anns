...
# Run pyramid v1 hnsw.
mpirun -n __NUM_OF_PROCS__ ../../pyramid_hnsw_hnswlib_v1.1.out __INPUT_FILE__ __INPUT_SIZE__ __DIM__ __SAMPLE_SIZE__ __M_CENTERS__ __BRANCHING_FACTOR__ __M__ __EF_CONSTRUCTION__ __OUTPUT_FILE__
