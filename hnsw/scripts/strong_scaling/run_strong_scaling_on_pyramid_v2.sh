...
for i in {0..9}; do
    ...
    OUTPUT_FILE="$OUTPUT_DIR/raw/strong_scaling_pyramid_v2_${NUM_OF_PROCS}.csv"
    OUTPUT_LOG_FILE="$OUTPUT_DIR/logs/strong_scaling_pyramid_v2_${NUM_OF_PROCS}.log"
    TEMP_SCRIPT="temp_strong_scaling_pyramid_v2_script_${NUM_OF_PROCS}.sh"
